...
namespace SonicRoute.Core
{
    ...
    public sealed class AppConfig
    {
        ...
        /// <summary>简洁面板固定高度（px）：用户设置的窗口恒定高度，展开/收起不改变；内容超出在应用区域滚动。</summary>
        public int QuickPanelHeight { get; set; } = 350;
        ...
        /// <summary>简洁面板应用列表最多显示行数（1–8，默认 3）：超出在列表内滚动；面板高度恒定，展开设备区不改变窗口高度。</summary>
