...
玩游戏、看视频或同时使用多个音频应用时，经常需要切换耳机 / 音箱、调整某个应用的音量、切换输入设备。Windows 本身已经具备这些能力，但这些操作通常需要进入系统音频界面才能完成。

SonicRoute 的目标不是替代 Windows 音频系统，而是把这些高频操作变得更快捷：

- 用快捷键直接操作当前应用
- 鼠标停在任务栏上滚轮即可调整当前应用音量
- 托盘里快速查看和控制正在出声的应用
- 全屏游戏中通过 OSD 获得反馈
- 根据应用启动、退出、定时等条件自动执行操作
...
- 🎯 **应用音频路由**：为游戏、浏览器、播放器、语音软件等应用分别选择输出和输入设备，支持当前应用 / 全局应用 / 系统默认控制
...
| ⚡ Lite ARM64（实验） | 实验版本，尚未完成 ARM64 真机完整验证 |
