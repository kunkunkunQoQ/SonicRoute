...
**v1.17** ｜ Win10/11 x64 ｜ C# / .NET 8 / WPF
...
- 🤖 **极简自动化**：快捷键 / 打开应用 / 切换应用触发，自动切设备、调音量、静音、启动程序（多操作顺序执行 + 多路径拖拽）
...
| 🟢 含运行环境版本 | `SonicRoute-v1.17.exe` / `.zip` | ~237MB / ~85MB | 已内置运行环境 |
| ⚡ 轻量版 | `SonicRoute-v1.17-Lite.exe` / `.zip` | ~27MB / ~6.8MB | 需 .NET 8 |
...
> 📌 **下一版本预告**：继续打磨自动化与快捷键体验 ｜ 优化 OSD / 面板动画与交互 ｜ 性能与内存优化 ｜ 国庆后大版本更新
